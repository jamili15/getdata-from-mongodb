...
const CONNECTION_TIMEOUT = gdxConnection["readTimeout"] ? +gdxConnection["readTimeout"] : 120 * 1000;
...
const RemoteProxy = (name, channel, connection, module) => {
  const invoke = async (method, args) => {
    const promise = new Promise((resolve, reject) => {
      ...
      console.log(`RemoteProxy [status] invoking ${params.service}.${params.method} channel: ${params.channel} connection: ${connection}`);
